...
clickCssElement(element) {this.cssfindElement(element).click()}
clickXpathElement(element) {this.xpathFindElement(element).click()}
clickForceXpathElement(element) {this.xpathFindElement(element).click({force:true})}
clickWithoutAttribut(element, text) {this.cssfindElement(element).invoke('removeAttr', text).click({force: true})}

elementCssIsVisible(element) { this.cssfindElement(element).should('be.visible')}
elementXpathIsVisible(element) { this.xpathFindElement(element).should('be.visible')}
